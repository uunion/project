            ...
            <div class="row">
                ...
                <!-- 글작성 -->
					<form role="form" method="post">
						...
						<input type="hidden" name="qbno" value="${QboardDto.qbno}">
					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<textarea class="form-control" name="qcontent" rows="3" 
								readonly="readonly">${QboardDto.qcontent}</textarea>
						</div>
						<div class="form-group">
							<label for="exampleInputEmail1">글쓴이</label>
							<input type="text" name="nwriter" class="form-control" value="${QboardDto.qwriter}" 
								readonly="readonly">
						</div>
					</div>
					<!-- /.box-body -->
					...
					<div class="box-footer">
						...
						<button type="submit" class="btn btn-primary" id="listAllBtn">목록</button>
					</div> 
            ...
            <div class="row">
                ...
                <div class="box box-success">
					...
					<div class="box-body">
						...
						<label for="newRcontent">글내용</label>
				...
				<ul class="timeline">
					...
					<li class="time-label" id="repliesDiv">
						<%-- <span class="bg-green">댓글 리스트 <small id="qreplycntSmall"> [ ${Qboard.qreplycnt} ]</small></span> --%>
						<div class="btn btn-danger" id="listrebtn">Replies List <small id="qreplycntSmall"> [ ${QboardDto.qreplycnt} ]</small></div>
					</li>
				</ul>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#modifyBtn").on("click", function(){
			formObj.attr("action", "/Qboard/update");
		...
		$("#removeBtn").on("click", function(){
			...
			var replyCnt = $("#qreplycntSmall").html().replace(/[^0-9]/g,"");
			...
			formObj.attr("action", "/Qboard/delete");
			formObj.submit();
		});
		
		$("#listAllBtn").on("click", function(){
			formObj.attr("method", "get");
			formObj.attr("action", "/Qboard/listPageMap");
			formObj.submit();
		});
		
		/* 댓글 목록 이벤트 */
		$("#listrebtn").on("click", function(){
			getPage("/Qreplies/" + qbno + "/1");
		});
		...
		$(".pagination").on("click", "li a", function(event){
			...
			getPage("/Qreplies/"+qbno+"/"+replyPage);
		});
		...
		$("#replyAddBtn").on("click", function(){
			...
			$.ajax({
				...
				dataType : 'text',
				data : JSON.stringify({qbno:qbno, rwriter:rwriter, rcontent:rcontent}),
		...
		function getPage(pageInfo){
			...
			$.getJSON(pageInfo, function(data){
				...
				$("#qreplycntSmall").html("[ " + data.pageMaker.totalCount + " ]");
			});
		}
