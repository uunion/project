...
$(document).ready(function() {
	...
	$(".update").on("click", function() {
		formObj.attr("action", "/admin/memberUpdate");
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type='hidden' name='mno' value="${memberDto.mno }">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="form-group">
                                            <label>이름</label>
                                            <input class="form-control" name="name" value="${memberDto.name}" readonly="readonly" >
                                           
                                        </div>
                                        
                                         <div class="form-group">
                                            <label>이메일</label>
                                            <input class="form-control" name="email" value="${memberDto.email }" readonly="readonly" >
                                        </div>
                                        
                                     
                                         <div class="form-group">
                                            <label>생년월일</label>
                                            <p><input class="form-control" id="datepicker" name="birth" value="${memberDto.birth }" readonly="readonly" ></p>
                                        </div>
                                         ...
                                         <div class="form-group">
                                            <label>핸드폰</label>
                                            <input class="form-control" name="phone" value="${memberDto.phone }" readonly="readonly" >
                                    ...
                                    <!--       <div class="form-group">
                                         ...
                                         -->
                                           ...
                                           <div class="form-group">
                                            <label>주소</label>
                                            <input class="form-control"  id="addr" name="addr" value="${memberDto.addr }" readonly="readonly" >
                                     
                                             <input class="form-control" id="deaddr" name="deaddr" value="${memberDto.deaddr}" readonly="readonly" >
