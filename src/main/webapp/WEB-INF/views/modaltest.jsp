...
<div id="testModal" class="modal modal-primary fade" role="dialog">
                ...
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                            ...
                            <fieldset>
                               ...
                               <button type="button" class="btn btn-lg btn-primary btn-block"  onclick="location.href = '../start'" >Facebook Login</button>
                               <!--  <button type="button" class="btn btn-block btn-social btn-facebook"><span class="fa fa-facebook"></span>Facebook</button> -->
